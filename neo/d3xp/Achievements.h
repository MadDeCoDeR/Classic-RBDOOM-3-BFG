...
enum classicAchievement_t {
	...
	CLASSIC_ACHIEVEMENT_CAMPAIGN_DOOM2, //DONE --> TESTED
	...
	CLASSIC_ACHIEVEMENT_CAMPAIGN_NRFTL, //DONE --> TESTED
	...
	CLASSIC_ACHIEVEMENT_KILLPEDIA, //DONE --> TESTED
	...
	CLASSIC_ACHIEVEMENT_SUPERWEAPON, //DONE --> TESTED
