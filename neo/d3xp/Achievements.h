...
enum classicAchievement_t {
	...
	CLASSIC_ACHIEVEMENT_FISTS, //DONE --> UNTESTED
	...
	CLASSIC_ACHIEVEMENT_SECRET_AREA, //DONE --> UNTESTED
	CLASSIC_ACHIEVEMENT_SECRET_LEVEL, //DONE --> UNTESTED
	CLASSIC_ACHIEVEMENT_BOOMSTICK, //DONE --> TESTED
	CLASSIC_ACHIEVEMENT_SUPERWEAPON,
	CLASSIC_ACHIEVEMENT_DOUBLEBOOMSTICK, //DONE --> TESTED
	CLASSIC_ACHIEVEMENT_UNTOUCHABLE, //DONE --> UNTESTED
