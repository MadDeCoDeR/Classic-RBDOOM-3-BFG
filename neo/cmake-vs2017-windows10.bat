...
cmake -G "Visual Studio 15 Win64" -DCMAKE_INSTALL_PREFIX=../bin/windows10-64 -DWINDOWS10=ON ../neo > NUL 2>&1
...
cmake -G "Visual Studio 15 Win64" -DCMAKE_INSTALL_PREFIX=../bin/win10-64 -DOPENAL=ON -DWINDOWS10=ON ../neo >NUL 2>&1
...
cmake -G "Visual Studio 15" -DCMAKE_INSTALL_PREFIX=../bin/windows10-32 -DWINDOWS10=ON ../neo > NUL 2>&1
...
cmake -G "Visual Studio 15" -DCMAKE_INSTALL_PREFIX=../bin/win10-32 -DOPENAL=ON -DWINDOWS10=ON ../neo >NUL 2>&1
