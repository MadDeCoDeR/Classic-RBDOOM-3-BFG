...
cmake -G "Visual Studio 16" -A "x64" -DCMAKE_INSTALL_PREFIX=../bin/windows10-64 -DWINRT=ON ../neo > ../buildlog/x64/log.txt
...
cmake -G "Visual Studio 16" -A "Win32" -DCMAKE_INSTALL_PREFIX=../bin/windows10-32 -DWINRT=ON ../neo > ../buildlog/x86/log.txt
