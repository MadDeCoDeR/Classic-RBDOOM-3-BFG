...
//#define WIDTH				( ORIGINAL_WIDTH * ::g->GLOBAL_IMAGE_SCALER )
//#define HEIGHT				( ORIGINAL_HEIGHT * ::g->GLOBAL_IMAGE_SCALER )
...
//#define ASPECT_OFFSET (::g->GLOBAL_IMAGE_SCALER + 1)

//#define	BASE_WIDTH			(ORIGINAL_WIDTH*ASPECT_OFFSET)
//#define SCREENWIDTH			WIDTH
//GK: End
//#define ::g->SCREENHEIGHT		HEIGHT

#define MAXWIDTH			ORIGINAL_WIDTH * 20
#define MAXHEIGHT			ORIGINAL_HEIGHT * 20
