...
namespace DoomLib
{
	...
	const ExpansionData App_Expansion_Data_Local[] = {
		{	ExpansionData::IWAD, retail,		doom,			"DOOM",								DOOMWADDIR"DOOM.WAD",		{},																											"base/textures/DOOMICON.PNG"	, Doom_MapNames, "The Ultimate DOOM" },
		{	ExpansionData::IWAD, commercial,	doom2,			"DOOM 2",							DOOMWADDIR"DOOM2.WAD",		{},																											"base/textures/DOOM2ICON.PNG"	, Doom2_MapNames, "DOOM 2: Hell On Earth" },
		{	ExpansionData::IWAD, commercial,	pack_tnt,		"FINAL DOOM: TNT EVILUTION",		DOOMWADDIR"TNT.WAD",		{},																											"base/textures/TNTICON.PNG"		, TNT_MapNames, "Final DOOM: TNT: Evilution" },
		{	ExpansionData::IWAD, commercial,	pack_plut,		"FINAL DOOM: PLUTONIA EXPERIMENT",	DOOMWADDIR"PLUTONIA.WAD",	{},																											"base/textures/PLUTICON.PNG"	, Plut_MapNames, "Final DOOM: The Plutonia Experiment" },
		{	ExpansionData::PWAD, commercial,	pack_master,	"DOOM 2: MASTER LEVELS",			DOOMWADDIR"DOOM2.WAD",		{DOOMWADDIR"MASTERLEVELS.WAD", DOOMWADDIR"mlbls.wad"},														"base/textures/MASTICON.PNG"	, Mast_MapNames, "DOOM 2: The Master Levels" },
		{	ExpansionData::PWAD, commercial,	pack_nerve,		"DOOM 2: NO REST FOR THE LIVING",	DOOMWADDIR"DOOM2.WAD",		{DOOMWADDIR"NERVE.WAD"},																					"base/textures/NERVEICON.PNG"	, Nerve_MapNames, "DOOM 2: No Rest For The Living" },
		{	ExpansionData::PWAD, retail,		pack_romero,	"DOOM: SIGIL",						DOOMWADDIR"DOOM.WAD",		{DOOMWADDIR"SIGIL.WAD", DOOMWADDIR"SIGIL_BFG.wad", DOOMWADDIR"SIGIL2.WAD", DOOMWADDIR"SIGIL_II_BFG.wad"},	"base/textures/SIGIL.PNG"		, Doom_MapNames, "DOOM: The SIGIL Episodes" },
		{	ExpansionData::PWAD, commercial,	pack_kex,		"DOOM: Legacy Of Rust",				DOOMWADDIR"DOOM2.WAD",		{DOOMWADDIR"ID1.WAD", DOOMWADDIR"ID1_BFG.wad"},																"base/textures/LOR.PNG"			, Doom2_MapNames, "DOOM 2: Legacy Of Rust" },
		{	ExpansionData::IWAD, shareware,		doom,			"DOOM Shareware",					DOOMWADDIR"DOOM1.WAD",		{},																										    "base/textures/DOOMICON.PNG"	, Doom_MapNames, "DOOM Shareware" }
	};
