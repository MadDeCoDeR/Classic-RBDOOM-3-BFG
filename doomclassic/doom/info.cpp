...
extern "C"
{
	...
	void A_BFGSpray(void* p1);
	void A_Explode(void* p1);
	void A_Pain(void* p1);
	void A_PlayerScream(void* p1);
	void A_Fall(void* p1);
	void A_XScream(void* p1);
	void A_Look(void* p1);
	void A_Chase(void* p1);
	void A_FaceTarget(void* p1);
	void A_PosAttack(void* p1);
	void A_Scream(void* p1);
	void A_SPosAttack(void* p1);
	void A_VileChase(void* p1);
	void A_VileStart(void* p1);
	void A_VileTarget(void* p1);
	void A_VileAttack(void* p1);
	void A_StartFire(void* p1);
	void A_Fire(void* p1);
	void A_FireCrackle(void* p1);
	void A_Tracer(void* p1);
	void A_SkelWhoosh(void* p1);
	void A_SkelFist(void* p1);
	void A_SkelMissile(void* p1);
	void A_FatRaise(void* p1);
	void A_FatAttack1(void* p1);
	void A_FatAttack2(void* p1);
	void A_FatAttack3(void* p1);
	void A_BossDeath(void* p1);
	void A_CPosAttack(void* p1);
	void A_CPosRefire(void* p1);
	void A_TroopAttack(void* p1);
	void A_SargAttack(void* p1);
	void A_HeadAttack(void* p1);
	void A_BruisAttack(void* p1);
	void A_SkullAttack(void* p1);
	void A_Metal(void* p1);
	void A_SpidRefire(void* p1);
	void A_BabyMetal(void* p1);
	void A_BspiAttack(void* p1);
	void A_Hoof(void* p1);
	void A_CyberAttack(void* p1);
	void A_PainAttack(void* p1);
	void A_PainDie(void* p1);
	void A_KeenDie(void* p1);
	void A_BrainPain(void* p1);
	void A_BrainScream(void* p1);
	void A_BrainDie(void* p1);
	void A_BrainAwake(void* p1);
	void A_BrainSpit(void* p1);
	void A_SpawnSound(void* p1);
	void A_SpawnFly(void* p1);
...
/*const*/ std::vector<state_t> tempStates {
    ...
    {SPR_SARG,0,2,{(actionf_p1)A_Chase},S_SARG_RUN2,0,0, FF_FAST},	// S_SARG_RUN1
    {SPR_SARG,0,2,{(actionf_p1)A_Chase},S_SARG_RUN3,0,0, FF_FAST},	// S_SARG_RUN2
    {SPR_SARG,1,2,{(actionf_p1)A_Chase},S_SARG_RUN4,0,0, FF_FAST},	// S_SARG_RUN3
    {SPR_SARG,1,2,{(actionf_p1)A_Chase},S_SARG_RUN5,0,0, FF_FAST},	// S_SARG_RUN4
    {SPR_SARG,2,2,{(actionf_p1)A_Chase},S_SARG_RUN6,0,0, FF_FAST},	// S_SARG_RUN5
    {SPR_SARG,2,2,{(actionf_p1)A_Chase},S_SARG_RUN7,0,0, FF_FAST},	// S_SARG_RUN6
    {SPR_SARG,3,2,{(actionf_p1)A_Chase},S_SARG_RUN8,0,0, FF_FAST},	// S_SARG_RUN7
    {SPR_SARG,3,2,{(actionf_p1)A_Chase},S_SARG_RUN1,0,0, FF_FAST},	// S_SARG_RUN8
    {SPR_SARG,4,8,{(actionf_p1)A_FaceTarget},S_SARG_ATK2,0,0, FF_FAST},	// S_SARG_ATK1
    {SPR_SARG,5,8,{(actionf_p1)A_FaceTarget},S_SARG_ATK3,0,0, FF_FAST},	// S_SARG_ATK2
    {SPR_SARG,6,8,{(actionf_p1)A_SargAttack},S_SARG_RUN1,0,0, FF_FAST},	// S_SARG_ATK3
    {SPR_SARG,7,2,{(actionf_v)NULL},S_SARG_PAIN2,0,0, FF_FAST},	// S_SARG_PAIN
    {SPR_SARG,7,2,{(actionf_p1)A_Pain},S_SARG_RUN1,0,0, FF_FAST},	// S_SARG_PAIN2
	...
	{ SPR_TNT1,0,-1,{(actionf_v)NULL},S_TNT1,0,0 },          // S_TNT1    // phares 3/8/98
};
